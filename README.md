# robotnik_motor_recovery

The robotnik_motor_recovery package, based on RComponent structure. Package to enable or disable the motors depending on the status of the base hardware
